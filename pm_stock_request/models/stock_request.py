...
_STATES = [
    ('draft', 'Draft'),
    ('to_approve', 'Request Stock'),
    ('approved', 'Call for bid'),
    ('rejected', 'Cancelled')
]
...
class StockRequest(models.Model):
    ...
    company_id = fields.Many2one('res.company', 'Company',
                                 ...
                                 track_visibility='onchange')
    line_ids = fields.One2many('stock.request.line', 'request_id',
...
class StockRequestLine(models.Model):
    ...
    product_id = fields.Many2one(
        ...
        track_visibility='onchange')
    name = fields.Text('Description', size=256,
                       track_visibility='onchange')
    ...
    customer_name = fields.Char('Customer name',
                                size=256,)
    cost_price = fields.Float(string='Standard Cost Price',
